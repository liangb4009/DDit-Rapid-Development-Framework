# -*- coding: UTF-8 -*-
#@create by marick, 2018-06-06, 2018世界杯球队分类
#图片分类到不同文件夹
...
class Application(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.classics = [(0,"Asia","A"),(1,"Africa","AF"),(2,"Latin","L"),(3,"Europe","E")]
        self.clas_v = tk.StringVar()
        self.clas_v.set("A")
        self.srcFolderPath = os.path.abspath(os.path.join(os.curdir,"2018WorldCup\\All\\"))
        self.trgFolderPath = os.path.abspath(os.path.join(os.curdir,"2018WorldCup\\"))
        self.pack()
        self.createWidgets()
    ...
    def getClassesFolderName(self):
        rtn = ""
        if self.clas_v.get() == "A": rtn = "Asia"
        if self.clas_v.get() == "AF": rtn = "Africa"
        if self.clas_v.get() == "L": rtn = "Latin"
        if self.clas_v.get() == "E": rtn = "Europe"
        return rtn
