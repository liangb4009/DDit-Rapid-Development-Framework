...
test = pd.read_csv(r"C:\Users\CN093128\Desktop\生产管理控制\2018-07-13 No.81 [图像识别]-识别手工数字\all\test.csv").values
...
prediction = tf.nn.softmax(y_conv,name='y_pred')
####################################################################
...
with tf.Session() as sess:
    sess.run(init)
    saver.restore(sess,r"D:\workspace\Project_Code\DDit-Rapid-Development-Framework.git\branches\prerelease\DDit.Python351\Tensorflow_5_models\Tensorflow5.ckpt-9")
